...
export const PASAJERO_MANUAL: ManualSection[] = [
  {
    heading: "1. Ubicación",
    body: [
      "Al abrir la app te va a pedir permiso de GPS. Tocá \"Permitir\" — es obligatorio, sin eso no podés pedir un viaje.",
      "Una vez que lo das, no te lo vuelve a preguntar — el navegador lo recuerda.",
      "Tu dirección real aparece en \"Tu ubicación\". Si querés forzar una relectura, tocá el ícono 🎯 sobre el mapa o el 🧭 junto a la dirección.",
    ],
  },
  {
    heading: "2. Pedir un viaje",
    body: [
      "Elegí destino en \"¿A dónde vamos?\" — hay buscador y destinos frecuentes.",
      "\"Para mí\" o \"Para otra persona\" (con nombre y teléfono, el conductor lo ve como referencia de recogida).",
      "Elegí categoría (Estándar o Rural 4x4) y método de pago, y confirmá — te va a dar un PIN de verificación.",
    ],
  },
  {
    heading: "3. Durante el viaje",
    body: [
      "Compartí el PIN con el conductor cuando llegue — sin el PIN no puede iniciar el viaje.",
      "Vas a ver la posición del auto en vivo en el mapa mientras viene y durante el trayecto.",
      "Podés cancelar antes de que el conductor llegue; después de aceptado puede aplicar un cargo por cancelación.",
    ],
  },
  {
    heading: "4. Pago y calificación",
    body: [
      "Al terminar el viaje, pagá con el método elegido (Webpay, CuentaRUT o efectivo).",
      "Calificá al conductor y dejá comentarios rápidos si querés.",
    ],
  },
];
...
export const CONDUCTOR_MANUAL: ManualSection[] = [
  {
    ...
    body: [
      ...
      "El punto GPS (arriba a la derecha) se pone verde cuando está activo. Si dice \"Denegado\", tocá \"Activar ubicación\" en el aviso que aparece.",
    ],
  },
  {
    heading: "2. Conectarte y recibir viajes",
    body: [
      "Tocá el botón de estado para pasar de \"Desconectado\" a \"Disponible\" — ahí empezás a recibir ofertas.",
      "Cuando llega una oferta tenés 15 segundos para Aceptar o Rechazar, con la ganancia neta y distancia de recogida a la vista.",
      "Al llegar al punto de recogida, pedile al pasajero el PIN de 4 dígitos para iniciar el viaje.",
    ],
  },
  {
    heading: "3. Ganancias",
    body: [
      ...
      "El % que te queda a vos (neto) lo define el admin, siempre entre 70% y 85% del valor del viaje.",
...
export const ADMIN_MANUAL: ManualSection[] = [
  ...
  {
    heading: "Geocercas",
    body: ["Las 4 zonas (Las Cabras Centro, Marina Golf, Llallauquén, El Manzano): editá el multiplicador dinámico y si exige 4x4."],
  },
  {
  ...
  },
  {
    ...
    body: [
      "Ajustá el % de comisión (15%–30%), tarifas de cancelación, cuota VIP mensual, y umbral/monto del bono semanal.",
      "Administrá los banners de publicidad (campañas) que ven pasajeros y conductores.",
    ],
  },
  {
    heading: "Reportes",
    body: [
      "Elegí un rango de fechas para ver ingresos, comisión, viajes completados/cancelados, ranking de conductores y uso por zona.",
